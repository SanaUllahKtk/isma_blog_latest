...
<div class="main-menu menu-fixed {{ $configData['theme'] === 'dark' ? 'menu-dark' : 'menu-light' }} menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto">
                <a class="navbar-brand" href="
                    @if (auth()->user()->isAdmin === '1') {{ url('admin/') }}
                    ...
                    {{-- </span> --}}
                    <h4 class="brand-text">{{ ucwords(str_replace('-', ' ', env('APP_NAME'))) }}</h4>
                </a>
            </li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ Route::currentRouteName() === $menu->slug ? 'active' : '' }} {{ $custom_classes }}">
                <a href="{{ route('admin.allblogs') }}" class="d-flex align-items-center" target="">
                    <i class="side-bar-icon">

                    </i>
                    <span class="menu-title text-truncate">Blogs Approved</span>
