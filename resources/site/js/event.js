...
(function App() {
    ...
    const calendar = `<div class="">
        ...
        `<th><span>${days[key].substring(0, 3)}</span></th>`
                ...
                <div class="col-md-6 col-12 d-flex justify-content-center pa-sm">
                    <div class="card border-0 mt-5 flex-fill d-none" id="event">
                        ...
                        <div class="card-body px-1 py-3">
                            ...
                            <div id="eventData" class="events-today my-3 px-3">
...
$(function () {
    ...
    $(document).on('click', '.showEvent', function () {
        ...
        showEvent(eventDate);
        fetchEvents(new Date(year, month, $(this).text()).toISOString().slice(0, 10));
    })
